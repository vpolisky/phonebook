<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  <v-container grid-list-md>
    <v-layout row wrap>
      ...
      <v-flex xs12 md4>
        <v-text-field label="Filter by name" v-model="name" clearable append-icon="person">
        </v-text-field>
      </v-flex>
      <v-flex xs12 md4>
        <v-text-field label="Filter by phone number" v-model="phone" clearable append-icon="phone">
        </v-text-field>
      </v-flex>
      <v-flex xs12 md4>
        <v-text-field label="Filter by address" v-model="address" clearable append-icon="place">
        </v-text-field>
      </v-flex>
